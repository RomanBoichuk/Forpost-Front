...
const DOUBLE_REGEXP = /^\d{0,11}(\.\d{0,4}){0,2}$/
...
const PHONE_NUMBER_REGEXP = /\(?([0-9]{3})\)?([ .-]?)([0-9]{3})\2([0-9]{3})/
...
export function phoneNumberValidation (message = 'This field must be a number (format 097 838 253).') {
